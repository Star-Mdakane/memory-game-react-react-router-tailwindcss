                ...
                <div className="flex flex-col gap-6 md:gap-8">
                    <fieldset className="flex flex-col">
                        ...
                        <div className="grid grid-cols-2 h-10 md:h-13 gap-2 md:gap-8">
                            <label htmlFor="numbers" className="h-full grid justify-center self-center cursor-pointer bg-sec-blue has-checked:bg-pri-blue rounded-[26px]">
                            ...
                            <label htmlFor="icons" className="h-full grid justify-center self-center cursor-pointer bg-sec-blue has-checked:bg-pri-blue rounded-[26px]">
                    ...
                    <fieldset className="flex flex-col">
                        ...
                        <div className="grid grid-cols-4 h-10 md:h-13 gap-2 md:gap-6">
                            <label htmlFor="one" className="h-full grid justify-center self-center cursor-pointer bg-sec-blue has-checked:bg-pri-blue rounded-[26px]">
                            ...
                            <label htmlFor="two" className="h-full grid justify-center self-center cursor-pointer bg-sec-blue has-checked:bg-pri-blue rounded-[26px]">
                            ...
                            <label htmlFor="three" className="h-full grid justify-center self-center cursor-pointer bg-sec-blue has-checked:bg-pri-blue rounded-[26px]">
                            ...
                            <label htmlFor="four" className="h-full grid justify-center self-center cursor-pointer bg-sec-blue has-checked:bg-pri-blue rounded-[26px]">
                    ...
                    <fieldset className="flex flex-col">
                        ...
                        <div className="grid grid-cols-2 h-10 md:h-13 gap-2 md:gap-8">
                            <label htmlFor="grid-4" className="h-full grid justify-center self-center cursor-pointer bg-sec-blue has-checked:bg-pri-blue rounded-[26px]">
